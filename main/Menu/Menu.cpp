...
Menu::Menu(Adafruit_SSD1306 *display, JoystickController *jController,
...
void Menu::display() {
  ...
  Serial.println(" ms to draw");
  Serial.print("Therefor we have: ");
  Serial.print(1000 / (end - start));
  Serial.println(" FPS");
}
...
void Menu::clearBody() {
  m_display->fillRect(0, 10, m_display->width(), m_display->height() - 10,
                      BLACK);
}
